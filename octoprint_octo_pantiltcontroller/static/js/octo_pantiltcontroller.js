$(function () {
    function PantiltViewModel(parameters) {
        ...
        self.requestData = function () {
            OctoPrint.simpleApiGet("octo_pantiltcontroller").done(function (
                response
            ) {
        ...
        self.createPanel = function () {
            ...
            panel.append($("<h1>Webcam Pan/Tilt Controller</h1>"));
        ...
        self.sendSetCommand = function () {
            OctoPrint.simpleApiCommand("octo_pantiltcontroller", "set", {
                panValue: self.panValue(),
                tiltValue: self.tiltValue(),
            }).done(self.requestData);
        };
        self.sendCommand = function (command) {
            OctoPrint.simpleApiCommand("octo_pantiltcontroller", command, {
